...
const StatIcon = {
  stack: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3 3 8l9 5 9-5-9-5zM3 13l9 5 9-5M3 18l9 5 9-5" /></svg>,
  code: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M8 8l-4 4 4 4M16 8l4 4-4 4M13 5l-2 14" /></svg>,
  heart: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 21s-7-4.4-9.3-8.5C1 9.5 2.5 6 6 6c2 0 3.2 1.2 4 2.3C10.8 7.2 12 6 14 6c3.5 0 5 3.5 3.3 6.5C19 16.6 12 21 12 21z" /></svg>,
};
  ...
  return (
    <div className="hero-quotes" data-reveal>
      <span className="hq-label">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M7 7h3v6H7a3 3 0 0 1-3-3V8a1 1 0 0 1 1-1zM17 7h3v6h-3a3 3 0 0 1-3-3V8a1 1 0 0 1 1-1z" /></svg>
        Words to ship by
      </span>
...
export default function Hero({ entered }) {
  ...
  return (
    <section id="top" className={"hero" + (entered ? " hero-live" : "")} ref={heroRef}>
      <div className="hero-amb-wrap" data-parallax data-speed="0.05" aria-hidden="true">
        <div className="hero-amb">
          <span className="hero-dots-wrap"><span className="hero-dots" /></span>
      ...
      <div className="hero-grid">
        <div className="hero-left" data-reveal>
          <span className="hero-stagger hero-hey">Hey, I&apos;m <i /></span>
          ...
          <p className="hero-stagger hero-role">Software Developer <i className="hd" /></p>
        ...
        <div className="hero-photo-outer" data-parallax data-speed="0.10">
          <div className="hero-photo-wrap" data-reveal>
            <div className="hero-photo">
              <span className="halo2-wrap"><span className="halo2" /></span>
              <span className="halo-wrap"><span className="halo" /></span>
              <span className="ring-wrap"><span className="ring" /></span>
              <span className="ring-wrap dotted"><span className="ring dotted" /></span>
      ...
      <div className="hero-connect" data-reveal>
        <span className="hero-connect-label">Let&apos;s connect <i /></span>
        <div className="hero-socials">
          <a href={profile.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" data-cursor>
          ...
          <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" data-cursor>
